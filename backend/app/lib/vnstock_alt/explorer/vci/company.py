...
from app.lib._vnstock_shared.core.utils.compat import replace_newlines_in_dataframe
...
from app.lib._vnstock_shared.compat import optimize_execution  # Import the decorator from vnai package
