...
from app.lib.vnstock_alt.config import Config
from app.lib.vnstock_alt.base import BaseAdapter, dynamic_method
from app.lib._vnstock_shared.core.types import (
    ParameterNames as P,
    MethodNames as M,
    DataSource,
    TimeFrame,
...
class Quote(BaseAdapter):
    ...
    def __init__(
        ...
        from app.lib.vnstock_alt import _ensure_explorer_modules_loaded
